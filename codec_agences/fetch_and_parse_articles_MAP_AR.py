...
from db_conf import DB_CONFIG, FTP_CONFIG_MAP_AR
# Configuration de la journalisation
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s - %(levelname)s - %(message)s",
    handlers=[
        logging.FileHandler("/home/codec_agences/logs/process_mapar.log"),
...
FTP_CONFIG = {
    "host": FTP_CONFIG_MAP_AR["host"],
    "user": FTP_CONFIG_MAP_AR["user"],
    "passwd": FTP_CONFIG_MAP_AR["passwd"],
}
...
def main():
    ...
    process_mapl_from_ftp(agency_id=11)  # MAP Arabe's ID
