...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/home/codec_agences/logs/process_azertacEn.log"),
...
# Traiter les fichiers Azertac En via FTP
def process_azertacEn_from_sftp(agency_id):
    try:
        ...
        logging.error(f"Failed to process Azertac En files from SFTP: {e}")

# Fonction principale
def main():
    logging.info("Starting Azertac En processing.")
    process_azertacEn_from_sftp(agency_id=21)  # Azertac En's ID
    logging.info("Azertac En processing completed.")
