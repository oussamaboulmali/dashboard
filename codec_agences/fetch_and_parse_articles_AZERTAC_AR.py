...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/home/codec_agences/logs/process_azertacAr.log"),
...
# Traiter les fichiers Azertac Ar via FTP
def process_azertacAr_from_sftp(agency_id):
    try:
        ...
        logging.error(f"Failed to process Azertac Ar files from SFTP: {e}")

# Fonction principale
def main():
    logging.info("Starting Azertac Ar processing.")
    process_azertacAr_from_sftp(agency_id=20)  # Azertac Ar's ID
    logging.info("Azertac Ar processing completed.")
